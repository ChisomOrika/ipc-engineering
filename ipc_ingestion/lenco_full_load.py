...
INGESTION_JOBS = [
    ...
    },
    {
        ...
        "pk_col":     "id",
        "data_key":   "bills",
        "index_cols": ["initiatedAt", "status", "category"],
        "paginated":  True,
    },
    {
    ...
    {
        "endpoint":   "point-of-sale/transactions",
        "table_name": "pos_transactions",
        "pk_col":     "id",
        "data_key":   "transactions",
        "index_cols": ["datetime", "status", "type"],
        "paginated":  True,
    },
]
...
def run_all(pg_conn_params: dict, resume: bool = True):
    log.info("=" * 60)
    log.info("Starting Lenco full load ingestion")
    log.info("=" * 60)
    ...
    log.info("=" * 60)
    log.info("Lenco full load ingestion complete")
    log.info("=" * 60)
