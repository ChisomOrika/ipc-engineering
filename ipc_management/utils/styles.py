...
# Brand colors
COLOR_DAASH    = "#8B0000"   # deep red
COLOR_GOSOURCE = "#2D5A27"   # army green
...
def page_header(title: str, subtitle: str = ""):
    """Header banner — dark indigo for management dashboard."""
    st.markdown(
        f"""<div style="background:linear-gradient(135deg,#1E1B4B 0%,#312E81 50%,#4338CA 100%);
            ...
            {f'<div style="font-size:13px;color:#C7D2FE;margin-top:4px;">{subtitle}</div>' if subtitle else ''}
        </div>""",
